    ...
    >
      <div className="bg-gradient-to-r from-primary to-secondary lg:py-0 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
          ...
          <nav className="hidden lg:flex flex-grow items-center justify-start">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              href="#"
              className="hidden lg:block bg-primary border border-primary text-white px-4 py-2 rounded-lg"
              onClick={() => {
            ...
            <Link
              href="#"
              className="hidden lg:block bg-primary text-white px-4 py-2 rounded-lg"
              onClick={() => {
            ...
            {isSignUpOpen && (
              <div ref={signUpRef} className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="relative mx-auto w-full max-w-md overflow-hidden rounded-lg bg-white px-8 py-14 text-center dark:bg-darklight">
                  <button
      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md sm:flex lg:justify-between justify-center py-5 hidden">
        ...
        <div className="flex items-center">
          <div className="flex gap-3 py-2 pr-6 border-r">
            ...
            />
            <div className="">
              <p className="text-14 font-normal text-muted mb-0">
                email us at
              </p>
              <Link href="#" className="text-base font-semibold mb-0 hover:text-primary uppercase">
                info@endeavor.com
              </Link>
            </div>
          </div>
          ...
          <Link href="#" className="text-error text-14 font-semibold border border-error py-4 px-7 rounded-md ml-8 hover:bg-error hover:text-white">
            Donate now
          </Link>
        </div>
      </div>
