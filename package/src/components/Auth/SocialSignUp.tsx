        ...
        <>
            <div className="flex gap-4">
                <button
                    ...
                    className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-solid hover:bg-stroke border-stroke p-3.5 text-dark duration-200 ease-in hover:border-gray-5 hover:bg-gray dark:border-dark_border dark:text-white dark:hover:bg-darkmode"
                >
                    Sign Up
                    <svg
                        width="23"
                ...
                <button
                    ...
                    className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-solid hover:bg-stroke border-stroke p-3.5 text-dark duration-200 ease-in hover:border-gray-5 hover:bg-gray dark:border-[#224767] dark:text-white dark:hover:bg-darkmode"
                >
                    Sign Up
                    <svg
                        width="22"
