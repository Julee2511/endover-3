          ...
          <div className="">
            <div className="grid md:grid-cols-6 lg:grid-cols-9 grid-cols-1 gap-7 border-b border-solid border-white border-opacity-50 pb-11">
              <div className="col-span-3">
                <h2 className="text-white text-40 font-bold">Pune<br /> Head Office</h2>
              </div>
              <div className="col-span-3">
              ...
              <div className="col-span-3">
                <Link href="mailto:headoffice@endeavor.com" className="sm:text-24 text-xl text-white font-medium underline">headoffice@endeavor.com</Link>
            ...
            <div className="grid md:grid-cols-6 lg:grid-cols-9 grid-cols-1 gap-7 pt-12">
              ...
              <div className="col-span-3">
                <Link href="mailto:office@endeavor.com" className="sm:text-24 text-xl text-white font-medium underline">office@endeavor.com</Link>
