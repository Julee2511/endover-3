          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center">
            <div className="col-span-8">
              <div className="flex flex-col sm:flex-row">
                <span className="text-16 text-midnight_text font-medium dark:text-white pr-7 border-r border-solid border-grey dark:border-white w-fit">
                  {format(new Date(post.date), "dd MMM yyyy")}
                </span>
                <span className="text-16 text-midnight_text font-medium dark:text-white sm:pl-7 pl-0 w-fit">13 Comments</span>
              </div>
              <h2 className="text-midnight_text dark:text-white md:text-40 text-36 font-bold pt-7">
                {post.title}
              </h2>
            </div>
            <div className="flex items-center md:justify-center justify-start gap-6 col-span-4 pt-4 md:pt-0">
              ...
              />
              <div className="">
                <span className="text-22 font-bold text-midnight_text dark:text-white">Silicaman</span>
        ...
        <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4">
              <div
                className="z-20 mb-16 h-80 overflow-hidden rounded md:h-45">
                <Image
                  src={post.coverImage}
                  alt="image"
                  width={1170}
                    ...
                    <div className="-mx-4 mb-8 flex flex-col">
                      ...
                      <div className="w-full py-12 px-11 bg-white dark:bg-darklight shadow-lg rounded-b-lg">
                        ...
                        <input
                          ...
                          className="p-3 dark:bg-gray-900 border border-border dark:border-dark_border rounded-lg mb-2 w-full focus:outline-0 focus:border-primary"
                        />
                        <button className="bg-gradient-to-r w-full from-primary to-secondary px-7 border text-16 text-white border-transparent py-4 rounded hover:from-transparent hover:to-transparent hover:border-primary hover:text-primary">
                          Subscribe
                        </button>
                      </div>
                    </div>
